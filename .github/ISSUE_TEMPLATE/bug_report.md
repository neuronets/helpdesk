...
e.g. are you using a distribution such as zero-to-jupyterhub or the-littlest-jupyterhub.
 ...
 - Version(s):
 <!-- e.g. nobrainer --version, python --version --->
...
<!--
Errors are often logged by nobrainer. How you get logs depends on your deployment. 
On your terminal/shell nobrainer will tell you where it saved the logs.
-->
